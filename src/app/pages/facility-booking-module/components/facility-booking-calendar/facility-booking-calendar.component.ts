...
@Component({
  selector: 'app-facility-booking-calendar',
  templateUrl: './facility-booking-calendar.component.html'
})
export class FacilityBookingCalendarComponent extends BaseComponemntComponent implements OnInit, BaseComponemntInterface {
  ...
  handleDateSelect(selectInfo: DateSelectArg) {
    ...
    // this.dataContent["actionValue"] = "service";
    // this.dataContent["start"] = selectInfo.startStr;
    // this.dataContent["end"] = selectInfo.endStr;
    // this.dataContent["serviceid"] = selectInfo?.resource?._resource?.id;
    ...
    // console.log("resource", selectInfo.resource);
  }
