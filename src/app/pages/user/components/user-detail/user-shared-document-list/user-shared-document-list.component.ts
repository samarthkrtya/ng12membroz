...
@Component({
  selector: 'app-user-shared-document-list',
  templateUrl: './user-shared-document-list.component.html',
})
export class UserSharedDocumentListComponent extends BaseLiteComponemntComponent implements OnInit {
  ...
  constructor(
    ...
    super();
    this.pagename = "app-user-shared-document-list";
  }
