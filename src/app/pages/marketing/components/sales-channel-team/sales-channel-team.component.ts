...
export class SalesChannelTeamComponent extends BaseComponemntComponent implements OnInit {
  ...
  constructor(
    ...
    this._route.params.forEach((params) => {
      this._formName = "saleschannelteam";
  ...
  async getSaleChannel() {
    ...
    await this._salesChannelTeamService
