...
export class VendorBasicDetailsComponent extends BaseLiteComponemntComponent implements OnInit {
    ...
    constructor(
        ...
        super()
        this.pagename = "app-vendor-basic-details";
    }
