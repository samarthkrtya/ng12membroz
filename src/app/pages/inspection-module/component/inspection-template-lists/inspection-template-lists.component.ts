...
@Component({
  selector: 'app-inspection-template-lists',
  templateUrl: './inspection-template-lists.component.html',
  styles: [
  ]
})
export class InspectionTemplateListsComponent extends BaseComponemntComponent implements OnInit, BaseComponemntInterface{
      ...
      if (result.value) {
        try {
          ...
          await varTemp._commonService
            ...
            .then(async (data) => {
              if (data) {
                varTemp.showNotification('top', 'right', 'Configured template deleted successfully !!', 'success');
  ...
  createFormField(oldformid: any, newformname: any, newformid: any) {
