...
@Component({
  selector: 'app-asset-basic-details',
  templateUrl: './asset-basic-details.component.html',
  styles: [
  ]
})
export class AssetBasicDetailsComponent  extends BaseLiteComponemntComponent implements OnInit {
  ...
  constructor(
    ...
    super();
    this.pagename="app-asset-basic-details";
  }
    ...
    const upsertResponse = fileItem => {
      ...
      if (fileItem) {
        if(fileItem.status == 200) {
          ...
          let method = "PATCH";
          let url = "assets/" + this.dataContent._id;
