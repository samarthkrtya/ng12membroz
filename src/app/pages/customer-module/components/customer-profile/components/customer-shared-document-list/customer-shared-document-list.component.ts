...
@Component({
  selector: 'app-customer-shared-document-list',
  templateUrl: './customer-shared-document-list.component.html',
  styles: [
  ]
})
export class CustomerSharedDocumentListComponent extends BaseLiteComponemntComponent implements OnInit  {
  ...
  constructor(
    ...
    super();
    this.pagename = "app-customer-shared-document-list";
  }
