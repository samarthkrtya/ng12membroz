...
@Component({
  selector: 'app-member-wallet-list',
  templateUrl: './member-wallet-list.component.html',
  styles: [
    `td { width:42px; height:42px; }
    `
  ]
})
export class MemberWalletListComponent extends BaseLiteComponemntComponent implements OnInit {
  ...
  constructor(
    private _commonService: CommonService,
      ...
      super();
      this.pagename="app-member-wallet-list";
   }
