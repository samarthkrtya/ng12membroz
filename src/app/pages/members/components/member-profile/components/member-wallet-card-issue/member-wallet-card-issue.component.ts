...
@Component({
  selector: 'app-member-wallet-card-issue',
  templateUrl: './member-wallet-card-issue.component.html',
  styles: [
    `table {
      width: 100%;
    }
...
export class MemberWalletCardIssueComponent extends BaseLiteComponemntComponent implements OnInit, AfterViewInit  {
