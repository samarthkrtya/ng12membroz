...
@Component({
  selector: 'app-member-signed-document-list',
  templateUrl: './member-signed-document-list.component.html',
  styles: [
  ]
})
export class MemberSignedDocumentListComponent extends BaseComponemntComponent implements OnInit {
  ...
  constructor(
    ...
    super();
    this.pagename = "app-member-signed-document-list";
