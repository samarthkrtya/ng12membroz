...
declare var $: any;
@Component({
  selector: 'app-lead-basic-details',
  templateUrl: './lead-basic-details.component.html',
  styles: [
  ]
})
export class LeadBasicDetailsComponent extends BaseLiteComponemntComponent implements OnInit {
  ...
  constructor(
    ...
    super()
    this.pagename="app-lead-basic-details";
   }
