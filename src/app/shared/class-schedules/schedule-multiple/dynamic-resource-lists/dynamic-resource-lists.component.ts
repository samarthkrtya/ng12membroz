...
@Component({
  selector: 'app-dynamic-resource-lists',
  templateUrl: './dynamic-resource-lists.component.html',
  styles: [
  ],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => DynamicResourceListsComponent),
      multi: true
    }
  ]
})
export class DynamicResourceListsComponent implements OnInit, ControlValueAccessor  {
