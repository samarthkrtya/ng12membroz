...
VendorviewSchema.plugin(mongooseautopopulate);

VendorviewSchema.options.selectPopulatedPaths = false;

VendorviewSchema.statics = {
...
module.exports = mongoose.model('Vendorview', VendorviewSchema);
