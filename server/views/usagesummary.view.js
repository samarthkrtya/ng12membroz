...
const UsagesummaryviewSchema = new mongoose.Schema({
...
UsagesummaryviewSchema.plugin(mongooseautopopulate);

UsagesummaryviewSchema.options.selectPopulatedPaths = false;

UsagesummaryviewSchema.statics = {
...
module.exports = mongoose.model('Usagesummaryview', UsagesummaryviewSchema);
